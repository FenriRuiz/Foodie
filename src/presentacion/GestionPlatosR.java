...
public class GestionPlatosR extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private JButton btnimagenComida;
	 ...
	 * @param listaComidas 
	 */
	public GestionPlatosR(Comida comida, ArrayList<Comida> listaComidas) {
		com = comida;
		...
		btnimagenComida = new JButton("");
		btnimagenComida.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		btnimagenComida.setBackground(new Color(255, 148, 62));
		btnimagenComida.setBorderPainted(false);
		btnimagenComida.setIcon(new ImageIcon(GestionPlatosR.class.getResource(comida.getRutaImagen())));
		GridBagConstraints gbc_btnimagenComida = new GridBagConstraints();
		gbc_btnimagenComida.gridwidth = 4;
		gbc_btnimagenComida.insets = new Insets(0, 0, 5, 0);
		gbc_btnimagenComida.gridx = 0;
		gbc_btnimagenComida.gridy = 3;
		add(btnimagenComida, gbc_btnimagenComida);
		...
		btnLact = new JButton("");
		btnLact.setToolTipText("Lactosa");
		...
		if(comida.isBwrLact()) {
			btnLact.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/leche64.png")));
		}else {
			btnLact.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/noleche64.png")));
		}
		...
		if(comida.isBwrMar()) {
			btnMar.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/camaron64.png")));
		}else {
			btnMar.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/nocamaron64.png")));
		}
		...
		btnFSec = new JButton("");
		btnFSec.setToolTipText("Frutos de Cascara");
		...
		if(comida.isBwrFSec()) {
			btnFSec.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/peanut64.png")));
		}else {
			btnFSec.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/nopeanut64.png")));
		}
		...
		if(comida.isBwrGlut()) {
			btnGlut.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/gluten64.png")));
		}else {
			btnGlut.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/nogluten64.png")));
		}
		...
		btnAddComida.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/icons8-comida-48.png")));
		...
		button.setIcon(new ImageIcon(GestionPlatosR.class.getResource("/recursos/icons8-eliminar-comida-48.png")));
	...
	private class BtnAddComidaActionListener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				comida.setIdentificador(lcomidas.size());
